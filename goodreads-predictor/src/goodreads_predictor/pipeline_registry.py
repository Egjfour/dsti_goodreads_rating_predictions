...
from .pipelines import data_load, word_embeddings, data_processing, model_data_creation, flaml_model, pycaret_models
...
def register_pipelines() -> Dict[str, Pipeline]:
    ...
    pycaret_model_pipeline = pycaret_models.create_pipeline()
    ...
    pipelines["flaml_model"] = flaml_model_pipeline
    pipelines["pycaret_model"] = pycaret_model_pipeline
    pipelines['run_all_models'] = flaml_model_pipeline + pycaret_model_pipeline # Run all models -- add to this as more models are created
